  ...
  return (
    <Card className="border-zinc-200/80 bg-white p-6 shadow-[0_20px_60px_rgba(15,23,42,0.08)] sm:p-8">
      ...
      <form className="mt-8 grid gap-5 sm:grid-cols-2" onSubmit={onSubmit}>
        ...
        <Field id="phoneOrWhatsapp" label={siteContent.leadForm.labels.phoneOrWhatsapp} required>
          <Input
            id="phoneOrWhatsapp"
        ...
        <Field id="monthlyEnquiryVolume" label={siteContent.leadForm.labels.monthlyEnquiryVolume} required>
          <Select
            value={form.monthlyEnquiryVolume}
            onValueChange={(value) => updateField("monthlyEnquiryVolume", value)}
          >
        ...
        <Field id="timeline" label={siteContent.leadForm.labels.timeline} required>
        ...
        <div className="sm:col-span-2">
          <Field id="currentTools" label={siteContent.leadForm.labels.currentTools} hint={siteContent.leadForm.hints.currentTools}>
            <Input
              id="currentTools"
        ...
        <div className="sm:col-span-2">
          <Field id="keyProblem" label={siteContent.leadForm.labels.keyProblem} hint={siteContent.leadForm.hints.keyProblem}>
            <Textarea
              id="keyProblem"
              value={form.keyProblem}
              onChange={(event) => updateField("keyProblem", event.target.value)}
