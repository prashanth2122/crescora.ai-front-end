  ...
  return (
    <>
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <SectionHeading eyebrow="What this page covers" title={page.title} description={page.description} />
      ...
      <section className="mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 pb-16 sm:px-6 lg:px-8">
        <SectionHeading eyebrow="Product screenshots" title="Show the operating surface buyers care about." description="Each panel highlights how the workflow behaves in production and what the team can actually verify." />
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <SectionHeading eyebrow="Implementation" title="A production rollout path, not a generic feature list." description="These phases keep the first deployment narrow, measurable, and safe to operate." />
        <div className="mt-10 grid gap-4 md:grid-cols-3">
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <SectionHeading eyebrow="Examples" title="Use cases and rollout patterns grounded in customer operations." description="These examples show how the same product surface is adapted to different jobs without changing the operating model." />
        ...
        <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
          <Card className="border-zinc-200 bg-white shadow-[0_20px_60px_rgba(15,23,42,0.05)]">
            <CardContent className="p-6 sm:p-8">
              <SectionHeading eyebrow="Proof" title="What the team verifies in the pilot." description="These are the operational signals that show whether the workflow is ready to expand." />
              <div className="mt-6 space-y-4">
                {page.proofPoints.map((point) => (
                  <div key={point.label} className="rounded-2xl border border-zinc-200 bg-zinc-50 px-4 py-4">
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <SectionHeading eyebrow="FAQ" title="Implementation questions buyers ask before rollout." description="The answers stay practical and product-specific instead of relying on search-result markup." />
        <Card className="border-zinc-200 bg-white shadow-[0_20px_60px_rgba(15,23,42,0.05)]">
          <CardContent className="p-6 sm:p-8">
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <SectionHeading eyebrow="Related pages" title="Move buyers to the right next decision." description="Primary revenue pages should connect to proof, pricing, and decision-stage content instead of duplicating more thin keyword pages." />
        <div className="mt-10 grid gap-4 md:grid-cols-3">
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
        <div className="rounded-[1.75rem] border border-zinc-200 bg-zinc-950 px-6 py-8 text-white shadow-[0_20px_60px_rgba(15,23,42,0.18)] sm:px-8">
          <p className="text-sm font-semibold uppercase tracking-[0.28em] text-white/50">Next step</p>
          <div className="mt-4 grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <h2 className="text-3xl font-semibold tracking-tight">{page.ctaLabel}</h2>
              <p className="mt-3 max-w-2xl text-sm leading-7 text-white/70">
                Scope the first workflow, confirm the success metric, and identify the owner handoff before expanding the automation surface.
              </p>
            </div>
            <div className="flex flex-wrap gap-3">
              <Button asChild className="h-12 rounded-full bg-white px-6 text-zinc-950 hover:bg-zinc-100">
                <Link href={page.ctaHref}>Request demo</Link>
              </Button>
