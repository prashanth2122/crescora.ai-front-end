...
const page = siteContent.templatesIndex;
  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pb-10 sm:px-6 lg:px-8">
        <div className="rounded-[1.5rem] border border-zinc-200 bg-white p-6 shadow-[0_20px_60px_rgba(15,23,42,0.05)] sm:p-8">
          ...
          <div className="mt-8 border-t border-zinc-200 pt-8">
            <SectionHeading
              eyebrow={page.launchStrip.eyebrow}
              title={page.launchStrip.title}
              description={page.launchStrip.supportLine}
            />
            <div className="mt-6 flex flex-wrap gap-2">
              {page.launchStrip.items.map((item) => (
                <Badge
                  key={item}
                  variant="secondary"
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        />
        <TemplateLibrarySection filters={page.filters} cards={page.cards} />
      </section>
