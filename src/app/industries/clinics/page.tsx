...
export const metadata = createExactPageMetadata({
  title: siteContent.industries.clinics.metadata.title,
  description: siteContent.industries.clinics.metadata.description,
  path: "/industries/clinics",
});

export default function ClinicsIndustryPage() {
  const page = siteContent.industries.clinics;
  const workflowIcons = [CalendarDays, UserRound, BellRing, CreditCard, Stethoscope, MessageSquareText, ShieldCheck];
  const safetyIcons = [ShieldCheck, CheckCircle2, MessageSquareText, CalendarDays];
  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
        ...
        <p className="mt-6 max-w-4xl text-sm leading-7 text-zinc-600">{page.workflowSection.supportLine}</p>
      </section>
