...
import { ArrowRight, BadgeCheck, BellRing, BookOpenText, CalendarDays, FileText, GraduationCap, LineChart, MessageSquareText, ShieldCheck, UserRound } from "lucide-react";
      ...
      <PageHero
        ...
        visual={
          <div className="overflow-hidden rounded-[2rem] border border-zinc-200 bg-[linear-gradient(180deg,rgba(255,255,255,0.94)_0%,rgba(244,244,245,0.96)_100%)] p-6 shadow-[0_24px_80px_rgba(15,23,42,0.08)] sm:p-7">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-zinc-500">Admissions workflow path</p>
