...
import { BadgeCheck, BellRing, BookOpenText, CalendarDays, FileText, GraduationCap, LineChart, MessageSquareText, ShieldCheck, UserRound } from "lucide-react";
...
export default function EducationPage() {
  ...
  const workflowIcons = [BookOpenText, UserRound, CalendarDays, FileText, BellRing, GraduationCap, LineChart, MessageSquareText];
  const trustIcons = [GraduationCap, BadgeCheck, BellRing, LineChart, ShieldCheck];
      ...
      <PageHero
        ...
        visual={
          <MarketingImageShowcase
            src="/marketing/school-workflows.png"
            alt="Crescora AI school and education workflow graphic for enquiries, admissions, demo classes, documents, and counsellor handover."
            caption="Education automation marketing visual using demo workflow content, not a live school deployment."
            priority
          />
        }
      />
