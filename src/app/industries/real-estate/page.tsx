...
import { BadgeCheck, BellRing, Building2, CalendarDays, FileText, Home, LineChart, MapPinned, ShieldCheck, UserRound } from "lucide-react";
      ...
      <PageHero
        ...
        visual={
          <MarketingImageShowcase
            src="/marketing/real-estate-usecases.png"
            alt="Crescora AI real estate automation workflow graphic for lead qualification, project sharing, site visits, and follow-ups."
            caption="Real estate automation marketing visual using demo workflow content, not a live brokerage or developer deployment."
            priority
          />
        }
      />
